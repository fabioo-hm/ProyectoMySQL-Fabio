...
('15480', 'Jenesano', '15'),
('15491', 'Jericó', '15'),
('15494', 'Labranzagrande', '15'),
('15500', 'La Capilla', '15'),
('15507', 'La Victoria', '15'),
('15511', 'La Uvita', '15'),
('15514', 'Villa de Leyva', '15'),
('15516', 'Macanal', '15'),
('15522', 'Maripí', '15'),
('15531', 'Miraflores', '15'),
('15537', 'Mongua', '15'),
...
('15755', 'Sáchica', '15'),
('15757', 'Samacá', '15'),
('15759', 'San Eduardo', '15'),
('15762', 'San José de Pare', '15'),
('15764', 'San Luis de Gaceno', '15'),
('15774', 'San Mateo', '15'),
('15776', 'San Miguel de Sema', '15'),
('15778', 'San Pablo de Borbur', '15'),
('15790', 'Santa María', '15'),
('15798', 'Santa Rosa de Viterbo', '15'),
('15804', 'Santa Sofía', '15'),
('15808', 'Santana', '15'),
('15810', 'Sativanorte', '15'),
('15814', 'Sativasur', '15'),
('15816', 'Siachoque', '15'),
('15820', 'Soatá', '15'),
('15822', 'Socha', '15'),
...
('16023', 'Tutazá', '15'),
('16078', 'Úmbita', '15'),
('16103', 'Ventaquemada', '15'),
('16125', 'Villa de Leiva', '15'),
('16180', 'Viracachá', '15'),
('16222', 'Zetaquira', '15'),
('17001', 'Manizales', '17'),
('17013', 'Aguadas', '17'),
...
('23300', 'Cotorra', '23'),
('23417', 'La Apartada', '23'),
('23464', 'Lorica', '23'),
('23466', 'Los Córdobas', '23'),
('23500', 'Momil', '23'),
('23555', 'Montelíbano', '23'),
('23660', 'Moñitos', '23'),
('23670', 'Planeta Rica', '23'),
('23672', 'Pueblo Nuevo', '23'),
('23675', 'Puerto Escondido', '23'),
('23678', 'Puerto Libertador', '23'),
('23682', 'Purísima', '23'),
('23686', 'Sahagún', '23'),
('23700', 'San Andrés Sotavento', '23'),
('23721', 'San Antero', '23'),
('23730', 'San Bernardo del Viento', '23'),
('23740', 'San Carlos', '23'),
('23755', 'San Pelayo', '23'),
('23807', 'Tierralta', '23'),
('23855', 'Valencia', '23'),
...
INSERT INTO citiesormunicipalities (code, name, statereg_id) VALUES
('US01001', 'Birmingham', 'US-AL'),
('US01002', 'Montgomery', 'US-AL'),
('US01003', 'Mobile', 'US-AL');

INSERT INTO citiesormunicipalities (code, name, statereg_id) VALUES
('US02001', 'Anchorage', 'US-AK'),
('US02002', 'Fairbanks', 'US-AK'),
('US02003', 'Juneau', 'US-AK');

INSERT INTO citiesormunicipalities (code, name, statereg_id) VALUES
('US04001', 'Phoenix', 'US-AZ'),
('US04002', 'Tucson', 'US-AZ'),
('US04003', 'Mesa', 'US-AZ');

INSERT INTO citiesormunicipalities (code, name, statereg_id) VALUES
('US06001', 'Los Angeles', 'US-CA'),
('US06002', 'San Diego', 'US-CA'),
('US06003', 'San Jose', 'US-CA'),
('US06004', 'San Francisco', 'US-CA');

INSERT INTO citiesormunicipalities (code, name, statereg_id) VALUES
('US36001', 'New York', 'US-NY'),
('US36002', 'Buffalo', 'US-NY'),
('US36003', 'Rochester', 'US-NY');

INSERT INTO citiesormunicipalities (code, name, statereg_id) VALUES
('US48001', 'Houston', 'US-TX'),
('US48002', 'San Antonio', 'US-TX'),
('US48003', 'Dallas', 'US-TX'),
('US48004', 'Austin', 'US-TX');

INSERT INTO citiesormunicipalities (code, name, statereg_id) VALUES
('US12001', 'Miami', 'US-FL'),
('US12002', 'Orlando', 'US-FL'),
('US12003', 'Tampa', 'US-FL'),
('US12004', 'Jacksonville', 'US-FL');
...
INSERT INTO membershipbenefits (membership_id, period_id, benefit_id, audience_id) VALUES
(1, 2, 1, 1),
(1, 2, 2, 2),
(2, 1, 3, 3);

INSERT INTO companies (id, type_id, name, category_id, address, city_id, audience_id, cellphone, email) VALUES
('COMP1', 1, 'Supermercado XYZ', 2, 'Calle 123', '05001', 1, '3101234567', 'xyz@empresa.com'),
('COMP2', 3, 'Tech Solutions', 3, 'Avenida Principal', 'US36001', 2, '3207654321', 'tech@soluciones.com'),
('COMP3', 1, 'Restaurante Gourmet', 1, 'Carrera 45', '11001', 3, '3158889999', 'gourmet@restaurante.com');
...
('Juan Pérez', '05001', 1, '3001112233', 'juan@mail.com'),
('María Gómez', '11001', 2, '3104445566', 'maria@mail.com'),
('John Doe', 'US36001', 3, '15551234567', 'john@mail.com');
